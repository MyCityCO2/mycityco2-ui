    ...
    <div class="methodology__section">
      <div>
        <p>
          ...
          incorporelles sont fixées pour chaque bien ou chaque catégorie de
          biens par l’assemblée délibérante, à l’exception toutefois :
        </p>
      ...
      <div>
        <p>
          Pour les autres immobilisations, l’assemblée peut se référer au barème
          indicatif ci-après :
        </p>
      ...
      <p>
        ...
        néanmoins une durée maximale de 7 ans pour les amortissements les plus
        longs. MyCityCO2 ne pouvant se fier au mécanisme de gestion des
        amortissements (cf ci-dessus), il faut reconstruire l’historique des
        amortissements pour constituer une image fidèle l’état des
        amortissements. Les données sont fournies depuis 2010, en générant les
        amortissements dès la date de l’investissement, cela nous permet après 7
        exercices, soit en 2016, d’avoir une vision complète des émissions des
        collectivités. C’est en 2016 que l’Accord de Paris est entré en vigueur,
        c’est donc depuis 2016 que la trajectoire des collectivités pourra être
        mesurée.
      </p>
    </div>
  </div>
