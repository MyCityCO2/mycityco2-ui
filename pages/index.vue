...
const { data: features } = await useAsyncData("index_features", () =>
  queryContent("_features").findOne()
);

const { data: stats } = await useAsyncData("index_stats", () =>
  queryContent("_stats").findOne()
);
</script>
...
<template>
  <div>
    <div
      class="relative isolate overflow-hidden bg-gradient-to-b from-emerald-100/20 pt-14"
    >
      <div
