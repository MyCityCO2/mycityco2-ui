...
const accountClasses = [
  {
    ...
    text: 'comporte la majeure partie des éléments regroupés dans cette classe par le PCG (fonds propres, emprunts et dettes assimilées), mais aussi des comptes spécifiques aux collectivités (FCTVA, TLE, …). Par ailleurs, le compte 13 « subventions d’investissement » retrace les subventions reçues et le compte 15 les provisions pour risques et charges.'
  },
  {
...
const accountClasses2 = [
  ...
  {
    key: 'Comptes de stocks et en-cours',
    text: 'comptes de bilan représentant l’état, ils n’entrent pas dans le calcul de l’empreinte carbone de la collectivité. Les dépenses effectuées pour mettre en stock ces produits auront été capturées soit via les comptes de charges soit les comptes d’immobilisations.'
  },
  {
  ...
  <div>
    ...
    <div class="methodology__section">
      <p>
        ...
        différents types de comptabilités se déclinent par des instructions comptables : M14 pour
        les communes, M52 pour les départements, M71 pour les régions, M4 pour les services à
        caractère industriel et commercial, M22 pour les ESMS, M31 pour les OPH etc.
      </p>
      <div>
        <p>
          MyCityCO2 s’appuie sur l’instruction M14 dont les classes de comptes sont les suivantes :
        </p>
      ...
      <div>
        <p>
          MyCityCO2 se focalise sur les classes 2 et 6 représentant les dépenses réelles,
          génératrices d’émissions de CO2.
        </p>
        <ul role="list" class="mt-2 space-y-2">
