...
<template>
  <div>
    <VHeading title="Mentions légales" text="" alt />
    <div class="mx-auto max-w-7xl px-6 lg:px-8 pb-24 space-y-5">
      <p>
        ...
        l'économie numérique, il est précisé aux utilisateurs du site MyCityCO2 l'identité des
      ...
      <h4>Hébergement</h4>
      <p>
        Le Site est hébergé par la société Infomaniak, situé Rue Eugène-Marziano 25, 1227 Genève,
        Suisse, (contact téléphonique ou email : (+41) 22 820 35 44).
      </p>
