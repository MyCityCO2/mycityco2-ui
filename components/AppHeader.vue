...
const stickyHeader = ref(process.client && window.scrollY > 10 ? true : false)
...
<template>
  ...
  >
    <div
      class="mx-auto flex flex-row max-w-7xl items-center justify-between pt-2 px-2 lg:px-8"
    >
    ...
    >
      <div class="flex lg:flex-1">
        <router-link :to="{ name: 'index' }" class="-m-1.5 p-1.5">
          <img
